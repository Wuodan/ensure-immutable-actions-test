...
|-------------|----------------------------------------------------------------------------------------------------|----:|----:|-----:|-------:|-----------:|
|✅ ACTION    |[actionlint](https://megalinter.io/beta/descriptors/action_actionlint)                              |   11|     |     0|       0|       0.21s|
|❌ ACTION    |[zizmor](https://megalinter.io/beta/descriptors/action_zizmor)                                      |   11|    4|    65|       0|       2.07s|
...
|✅ JSON      |[jsonlint](https://megalinter.io/beta/descriptors/json_jsonlint)                                    |    9|     |     0|       0|       0.27s|
|✅ JSON      |[prettier](https://megalinter.io/beta/descriptors/json_prettier)                                    |    9|    7|     0|       0|       0.22s|
|✅ JSON      |[v8r](https://megalinter.io/beta/descriptors/json_v8r)                                              |    9|     |     0|       0|       1.28s|
|✅ MARKDOWN  |[markdownlint](https://megalinter.io/beta/descriptors/markdown_markdownlint)                        |    2|    0|     0|       0|       0.43s|
|✅ MARKDOWN  |[markdown-table-formatter](https://megalinter.io/beta/descriptors/markdown_markdown_table_formatter)|    2|    1|     0|       0|       0.16s|
|✅ REPOSITORY|[betterleaks](https://megalinter.io/beta/descriptors/repository_betterleaks)                        |  yes|     |    no|      no|       0.77s|
|✅ REPOSITORY|[checkov](https://megalinter.io/beta/descriptors/repository_checkov)                                |  yes|     |    no|      no|      12.25s|
|✅ REPOSITORY|[devskim](https://megalinter.io/beta/descriptors/repository_devskim)                                |  yes|     |    no|      no|        1.2s|
|✅ REPOSITORY|[dustilock](https://megalinter.io/beta/descriptors/repository_dustilock)                            |  yes|     |    no|      no|       0.16s|
|✅ REPOSITORY|[gitleaks](https://megalinter.io/beta/descriptors/repository_gitleaks)                              |  yes|     |    no|      no|       0.22s|
|✅ REPOSITORY|[git_diff](https://megalinter.io/beta/descriptors/repository_git_diff)                              |  yes|     |    no|      no|       0.13s|
|✅ REPOSITORY|[grype](https://megalinter.io/beta/descriptors/repository_grype)                                    |  yes|     |    no|      no|      33.39s|
|✅ REPOSITORY|[kingfisher](https://megalinter.io/beta/descriptors/repository_kingfisher)                          |  yes|     |    no|      no|       5.13s|
|✅ REPOSITORY|[osv-scanner](https://megalinter.io/beta/descriptors/repository_osv_scanner)                        |  yes|     |    no|      no|       0.25s|
|✅ REPOSITORY|[secretlint](https://megalinter.io/beta/descriptors/repository_secretlint)                          |  yes|     |    no|      no|       0.55s|
|✅ REPOSITORY|[syft](https://megalinter.io/beta/descriptors/repository_syft)                                      |  yes|     |    no|      no|       1.57s|
|✅ REPOSITORY|[trivy](https://megalinter.io/beta/descriptors/repository_trivy)                                    |  yes|     |    no|      no|       6.96s|
...
|❌ SPELL     |[cspell](https://megalinter.io/beta/descriptors/spell_cspell)                                       |   31|     |    58|       0|       2.52s|
|❌ SPELL     |[lychee](https://megalinter.io/beta/descriptors/spell_lychee)                                       |   27|     |     3|       0|        0.2s|
|✅ YAML      |[prettier](https://megalinter.io/beta/descriptors/yaml_prettier)                                    |   16|    4|     0|       0|       0.32s|
|✅ YAML      |[v8r](https://megalinter.io/beta/descriptors/yaml_v8r)                                              |   16|     |     0|       0|        2.9s|
