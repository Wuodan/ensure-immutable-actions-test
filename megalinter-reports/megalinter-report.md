...
|-------------|----------------------------------------------------------------------------------------------------|----:|----:|-----:|-------:|-----------:|
|✅ ACTION    |[actionlint](https://megalinter.io/beta/descriptors/action_actionlint)                              |   11|     |     0|       0|       0.22s|
|❌ ACTION    |[zizmor](https://megalinter.io/beta/descriptors/action_zizmor)                                      |   11|    4|    65|       0|       2.26s|
|✅ BASH      |[bash-exec](https://megalinter.io/beta/descriptors/bash_bash_exec)                                  |    1|     |     0|       0|       0.15s|
|✅ BASH      |[shellcheck](https://megalinter.io/beta/descriptors/bash_shellcheck)                                |    1|     |     0|       0|       0.03s|
|✅ BASH      |[shfmt](https://megalinter.io/beta/descriptors/bash_shfmt)                                          |    1|    1|     0|       0|       0.02s|
|✅ COPYPASTE |[jscpd](https://megalinter.io/beta/descriptors/copypaste_jscpd)                                     |  yes|     |    no|      no|       0.29s|
|✅ JSON      |[jsonlint](https://megalinter.io/beta/descriptors/json_jsonlint)                                    |    9|     |     0|       0|       0.23s|
|✅ JSON      |[prettier](https://megalinter.io/beta/descriptors/json_prettier)                                    |    9|    7|     0|       0|       0.27s|
|✅ JSON      |[v8r](https://megalinter.io/beta/descriptors/json_v8r)                                              |    9|     |     0|       0|       1.79s|
|✅ MARKDOWN  |[markdownlint](https://megalinter.io/beta/descriptors/markdown_markdownlint)                        |    1|    0|     0|       0|        0.4s|
|✅ MARKDOWN  |[markdown-table-formatter](https://megalinter.io/beta/descriptors/markdown_markdown_table_formatter)|    1|    0|     0|       0|       0.14s|
|✅ REPOSITORY|[betterleaks](https://megalinter.io/beta/descriptors/repository_betterleaks)                        |  yes|     |    no|      no|       1.04s|
|✅ REPOSITORY|[checkov](https://megalinter.io/beta/descriptors/repository_checkov)                                |  yes|     |    no|      no|      13.31s|
|✅ REPOSITORY|[devskim](https://megalinter.io/beta/descriptors/repository_devskim)                                |  yes|     |    no|      no|       1.53s|
|✅ REPOSITORY|[dustilock](https://megalinter.io/beta/descriptors/repository_dustilock)                            |  yes|     |    no|      no|       0.16s|
|✅ REPOSITORY|[gitleaks](https://megalinter.io/beta/descriptors/repository_gitleaks)                              |  yes|     |    no|      no|       0.33s|
|✅ REPOSITORY|[git_diff](https://megalinter.io/beta/descriptors/repository_git_diff)                              |  yes|     |    no|      no|       0.15s|
|✅ REPOSITORY|[grype](https://megalinter.io/beta/descriptors/repository_grype)                                    |  yes|     |    no|      no|      35.01s|
|✅ REPOSITORY|[kingfisher](https://megalinter.io/beta/descriptors/repository_kingfisher)                          |  yes|     |    no|      no|       6.14s|
|✅ REPOSITORY|[osv-scanner](https://megalinter.io/beta/descriptors/repository_osv_scanner)                        |  yes|     |    no|      no|       0.23s|
|✅ REPOSITORY|[secretlint](https://megalinter.io/beta/descriptors/repository_secretlint)                          |  yes|     |    no|      no|       0.63s|
|✅ REPOSITORY|[syft](https://megalinter.io/beta/descriptors/repository_syft)                                      |  yes|     |    no|      no|       1.85s|
|✅ REPOSITORY|[trivy](https://megalinter.io/beta/descriptors/repository_trivy)                                    |  yes|     |    no|      no|      12.56s|
|✅ REPOSITORY|[trivy-sbom](https://megalinter.io/beta/descriptors/repository_trivy_sbom)                          |  yes|     |    no|      no|       0.28s|
|✅ REPOSITORY|[trufflehog](https://megalinter.io/beta/descriptors/repository_trufflehog)                          |  yes|     |    no|      no|       2.44s|
|❌ SPELL     |[cspell](https://megalinter.io/beta/descriptors/spell_cspell)                                       |   29|     |    57|       0|       3.24s|
|❌ SPELL     |[lychee](https://megalinter.io/beta/descriptors/spell_lychee)                                       |   25|     |     3|       0|       0.23s|
|✅ YAML      |[prettier](https://megalinter.io/beta/descriptors/yaml_prettier)                                    |   15|    4|     0|       0|       0.42s|
|✅ YAML      |[v8r](https://megalinter.io/beta/descriptors/yaml_v8r)                                              |   15|     |     0|       0|       3.34s|
|✅ YAML      |[yamllint](https://megalinter.io/beta/descriptors/yaml_yamllint)                                    |   15|     |     0|       0|       0.43s|

## Detailed Issues

<details>
<summary>❌ SPELL / cspell - 57 errors</summary>

```
.github/workflows/ci_lint.yml:55:20     - Unknown word (pipefail)   -- set -euo pipefail
	 Suggestions: [pipeful, pineal, pigtail, pintail, pitfall]
.github/workflows/ci_lint.yml:78:15     - Unknown word (Wuodan)     -- uses: Wuodan/megalinter@beta
...
scripts/render-fixtures.sh:53:21     - Unknown word (Wuodan)     -- -e "s|\"owner\": \"Wuodan\"|\"owner\": \"$FIXTURES
	 Suggestions: [houdan, Houdan, soudan, Soudan, Woden]
CSpell: Files checked: 29, Issues found: 57 in 18 files.
...
help[artipacked]: credential persistence through GitHub Actions artifacts
  --> .github/workflows/ci_lint.yml:61:9
   |
61 |         - name: Checkout
   |  _________^
62 | |         uses: actions/checkout@HIDDEN_BY_MEGALINTER# v7.0.0
63 | |         with:
64 | |           token: ${{ secrets.PAT || github.token }}
65 | |           fetch-depth: 0
...
error[unpinned-uses]: unpinned action reference
  --> .github/workflows/ci_lint.yml:78:15
   |
78 |         uses: Wuodan/megalinter@beta
