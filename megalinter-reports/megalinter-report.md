...
|-------------|----------------------------------------------------------------------------------------------------|----:|----:|-----:|-------:|-----------:|
|✅ ACTION    |[actionlint](https://megalinter.io/beta/descriptors/action_actionlint)                              |   11|     |     0|       0|       0.18s|
|❌ ACTION    |[zizmor](https://megalinter.io/beta/descriptors/action_zizmor)                                      |   11|    4|    65|       0|       2.26s|
|✅ BASH      |[bash-exec](https://megalinter.io/beta/descriptors/bash_bash_exec)                                  |    1|     |     0|       0|       0.13s|
|✅ BASH      |[shellcheck](https://megalinter.io/beta/descriptors/bash_shellcheck)                                |    1|     |     0|       0|       0.03s|
|✅ BASH      |[shfmt](https://megalinter.io/beta/descriptors/bash_shfmt)                                          |    1|    1|     0|       0|       0.12s|
|✅ COPYPASTE |[jscpd](https://megalinter.io/beta/descriptors/copypaste_jscpd)                                     |  yes|     |    no|      no|       0.21s|
|✅ JSON      |[jsonlint](https://megalinter.io/beta/descriptors/json_jsonlint)                                    |    9|     |     0|       0|       0.18s|
|✅ JSON      |[prettier](https://megalinter.io/beta/descriptors/json_prettier)                                    |    9|    7|     0|       0|        0.2s|
|✅ JSON      |[v8r](https://megalinter.io/beta/descriptors/json_v8r)                                              |    9|     |     0|       0|       1.45s|
|✅ MARKDOWN  |[markdownlint](https://megalinter.io/beta/descriptors/markdown_markdownlint)                        |    2|    0|     0|       0|        0.3s|
|✅ MARKDOWN  |[markdown-table-formatter](https://megalinter.io/beta/descriptors/markdown_markdown_table_formatter)|    2|    0|     0|       0|       0.16s|
|✅ REPOSITORY|[betterleaks](https://megalinter.io/beta/descriptors/repository_betterleaks)                        |  yes|     |    no|      no|       0.84s|
|✅ REPOSITORY|[checkov](https://megalinter.io/beta/descriptors/repository_checkov)                                |  yes|     |    no|      no|      10.93s|
|✅ REPOSITORY|[devskim](https://megalinter.io/beta/descriptors/repository_devskim)                                |  yes|     |    no|      no|       1.07s|
|✅ REPOSITORY|[dustilock](https://megalinter.io/beta/descriptors/repository_dustilock)                            |  yes|     |    no|      no|       0.13s|
|✅ REPOSITORY|[gitleaks](https://megalinter.io/beta/descriptors/repository_gitleaks)                              |  yes|     |    no|      no|       0.26s|
|✅ REPOSITORY|[git_diff](https://megalinter.io/beta/descriptors/repository_git_diff)                              |  yes|     |    no|      no|       0.14s|
|✅ REPOSITORY|[grype](https://megalinter.io/beta/descriptors/repository_grype)                                    |  yes|     |    no|      no|      32.32s|
|✅ REPOSITORY|[kingfisher](https://megalinter.io/beta/descriptors/repository_kingfisher)                          |  yes|     |    no|      no|       5.43s|
|✅ REPOSITORY|[osv-scanner](https://megalinter.io/beta/descriptors/repository_osv_scanner)                        |  yes|     |    no|      no|       0.21s|
|✅ REPOSITORY|[secretlint](https://megalinter.io/beta/descriptors/repository_secretlint)                          |  yes|     |    no|      no|       0.69s|
|✅ REPOSITORY|[syft](https://megalinter.io/beta/descriptors/repository_syft)                                      |  yes|     |    no|      no|       1.49s|
|✅ REPOSITORY|[trivy](https://megalinter.io/beta/descriptors/repository_trivy)                                    |  yes|     |    no|      no|       7.22s|
|✅ REPOSITORY|[trivy-sbom](https://megalinter.io/beta/descriptors/repository_trivy_sbom)                          |  yes|     |    no|      no|       0.22s|
|✅ REPOSITORY|[trufflehog](https://megalinter.io/beta/descriptors/repository_trufflehog)                          |  yes|     |    no|      no|       1.87s|
|❌ SPELL     |[cspell](https://megalinter.io/beta/descriptors/spell_cspell)                                       |   31|     |    58|       0|       2.59s|
|❌ SPELL     |[lychee](https://megalinter.io/beta/descriptors/spell_lychee)                                       |   27|     |     3|       0|       0.18s|
|✅ YAML      |[prettier](https://megalinter.io/beta/descriptors/yaml_prettier)                                    |   16|    4|     0|       0|       0.26s|
|✅ YAML      |[v8r](https://megalinter.io/beta/descriptors/yaml_v8r)                                              |   16|     |     0|       0|       2.82s|
|✅ YAML      |[yamllint](https://megalinter.io/beta/descriptors/yaml_yamllint)                                    |   16|     |     0|       0|       0.36s|
...
```
.github/actions/close-pull-request/action.yml:39:18     - Unknown word (pipefail)   -- set -euo pipefail
